    ...
    return (
        <>
            ...
            <nav ref={navRef} className="w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50">
                ...
                <a href="#!">
                    <img src="./assets/A.png" alt="Logo" className="w-40 cursor-pointer mr-15 dark:hidden" />
                    <img src="./assets/Anchal.png" alt="Logo" className="w-40 cursor-pointer mr-15 hidden dark:block" />
                </a>
